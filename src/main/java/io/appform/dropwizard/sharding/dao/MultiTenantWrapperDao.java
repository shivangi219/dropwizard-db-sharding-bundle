 ...
 */
@Slf4j
public class MultiTenantWrapperDao<T, DaoType extends AbstractDAO<T>> implements ShardedDao<T> {
     ...
     */
    public MultiTenantWrapperDao(List<SessionFactory> sessionFactories, Class<DaoType> daoClass, ShardCalculator<String> shardCalculator) {
